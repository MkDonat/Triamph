...
void setup_sensor_fusion() {
  // --- INITIAL SETUP ---
  //Serial.begin(SYSTEM_BAUD_RATE); // Initialize serial communication for debugging
...
void operating_sensor_fusion(void *args) {
